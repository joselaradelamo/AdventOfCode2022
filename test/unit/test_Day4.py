...
class TesDay4(unittest.TestCase):
  def test_list_part1_example(self):
    self.assertEqual(part1(getExample("Day4")), 2)
  def test_list_part1_input(self):
    self.assertEqual(part1(getInput("Day4")), 605)
  def test_list_part2_example(self):
    self.assertEqual(part2(getExample("Day4")), 4)
  def test_list_part2_input(self):
    self.assertEqual(part2(getInput("Day4")), 914)
