...
class TesDay3(unittest.TestCase):
  def test_list_part1_example(self):
    self.assertEqual(part1(getExample("Day3")), 157)
  def test_list_part1_input(self):
    self.assertEqual(part1(getInput("Day3")), 7742)
  def test_list_part2_example(self):
    self.assertEqual(part2(getExample("Day3")), 70)
  def test_list_part2_input(self):
    self.assertEqual(part2(getInput("Day3")), 2276)
